...
const Navbar = () => {
  ...
  const handleLogout = () => {
    // Implement logout logic (clear session storage, etc.)
  ...
  return (
    <nav>
      ...
      <div className="nav__icon">
        {/* You can add a menu icon or any other icon if needed */}
        ...
        {isLoggedIn ? (
          <>
            <li className="link">
              ...
              <button className="btn1" onClick={() => navigate('/booking-consultation"')}>
                Welcome, {userName}!
              </button>
            </li>
            <li className="link">
